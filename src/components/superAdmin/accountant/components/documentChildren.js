    ...
    <div className="row">
        ...
        <div className="col col-md-1">
            ...
            <label id={`toltipUpload${props.indexFather}${props.indexChildren}`}
                ...
                className="btn btn-light" htmlFor="handleUploadDocumentLegal"><i className="fa fa-upload"></i>
            </label>
        </div>
        {
            props.child.url !== '' &&
            <div className="col col-md-5 row">
                <div className="col col-md-2">
                    ...
                    <a id={`toltipView${props.indexFather}${props.indexChildren}`} className="btn btn-light" data-fancybox={`fancy${props.indexFather}${props.indexChildren}`} data-type="iframe" data-src={props.child.url} href="javascript:;">
                ...
                </div>
                {
                    ...
                    <div className="col col-md-2">
                        ...
                        <a id={`toltipViewInterpretation${props.indexFather}${props.indexChildren}`} className="btn btn-light" data-fancybox={`fancy${props.indexFather}${props.indexChildren}`} data-type="iframe" data-src={props.child.urlInterpretation} href="javascript:;">
                            <i className="fa fa-eye"></i>
                        </a>
                    </div>
                }
        ...
        <div className="col col-md-1">
            ...
            <button onClick={() => props.handleDeleteChildren(props.indexFather, props.indexChildren)} type="button" id={`toltipDeleteChildren${props.indexFather}${props.indexChildren}`} className="btn btn-warning"><i className="fa fa-trash"></i> </button>
        </div>
